...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-[999]  bg-[rgba(00,00,00,0.9)] shadow-sm">
            <div className="mx-auto max-w-7xl px-4">
                <div className="flex pt-2 pb-2 items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <motion.a
                            href=""
                            className="flex items-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white poppins-thin cursor-pointer border-2 border-green-500"
                    ...
                    >
                        <svg xmlns="www.w3.org" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
            ...
            <div
                className={`fixed top-0 right-0 h-full w-64 bg-[#000] shadow-lg transform transition-transform duration-300 ease-in-out z-50
